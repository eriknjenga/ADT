...
<html>
<head runat="server">
    <title>FusionCharts Examples - Using ASP.NET.AJAX UpdatePanel #1</title>
            ...
            <table style="border: 1px dotted #aaaaaa;" width="778px">
                <tr>
                    <td align="center" valign="middle" colspan="2">
                        <h2>FusionCharts Example - UpdatePanel #1</h2>
                        <h4>Using ASP.NET.AJAX</h4>
                        <h5>Please select a Factory</h5>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td valign="middle" style="width: 320px; height: 299px; border-right: #cdcdcd 1px dotted;
                        ...
                        <asp:UpdateProgress ID="UpdateProgress1" runat="server" DisplayAfter="1">
                            <ProgressTemplate>
                                <img style="position: absolute; top: 324px; left: 153px; z-index: 5;" src="Images/loading.gif" />
                            </ProgressTemplate>
                        </asp:UpdateProgress>
                    </td>
                    <td valign="middle" style="width: 440px; height: 350px; border: 1px dotted #dedede;">
                        ...
                        <asp:UpdateProgress ID="UpdateProgress2" runat="server" DisplayAfter="1">
                            <ProgressTemplate>
                                <img src="Images/loading.gif" style="position: absolute; top: 327px; left: 564px;
                                    z-index: 5;" />
                            </ProgressTemplate>
                        </asp:UpdateProgress>
                    </td>
