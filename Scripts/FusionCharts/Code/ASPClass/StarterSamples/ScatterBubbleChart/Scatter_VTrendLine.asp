...
<%
  ...
  ' Add a new dataset 
  Call FC.addDataSet("Server 1","anchorRadius=6;;color=880000")
  ...
  ' Add another dataset
  Call FC.addDataSet("Server 2","anchorRadius=6;;color=000088")
  ' Add chart data for the above dataset
  ' where 1st parameter for X axis value
  ' 2nd parameter take Y axis as parameter list
  ' e.g y=30
  ...
  Call FC.addVTrendLine("startValue=25;endValues=25;isTrendZone=0;color=FF0000;alpha=50")  
  
  ' Add Second VTrendLine 
  Call FC.addVTrendLine("startValue=10;endValue=20;alpha=25;color=00FF00")
