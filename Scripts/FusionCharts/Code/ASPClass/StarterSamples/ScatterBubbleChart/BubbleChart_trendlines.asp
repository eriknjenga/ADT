...
<%
  ...
  ' Add TrendLine
  Call FC.addTrendLine("startValue=50000;endValue=50000;color=00FF00;displayvalue=First Target;dashed=1")
  
  ' Add vTrendLine 
  Call FC.addvTrendLine("startValue=0;endValue=39.99;color=888800;displayvalue=Low Sales;alpha=20")
