					...
					} else if (arrLevel1Nodes [j].nodeName.toUpperCase () == "LINESET")
					{
						...
						for (k = 0; k < arrLevel2Nodes.length; k ++)
						{
							if (arrLevel2Nodes [k].nodeName.toUpperCase () == "SET")
							{
								...
								//Store all these attributes as object.
								this.ldataset [this.numLDS].data [setCount] = this.returnDataAsLineObject (setValue, setColor, setExDispVal, Number (setAlpha) , setToolText, setLink, setShowValue, setDashed, setAnchorSides, setAnchorRadius, setAnchorBorderColor, setAnchorBorderThickness, setAnchorBgColor, setAnchorAlpha, setAnchorBgAlpha);
							}
						}
