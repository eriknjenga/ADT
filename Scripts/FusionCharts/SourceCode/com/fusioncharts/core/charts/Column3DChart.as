...
class com.fusioncharts.core.charts.Column3DChart extends SingleYAxis3DChart 
{
	...
	*/
	function Column3DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		_arrObjects = new Array ("BACKGROUND", "CANVAS", "CAPTION", "SUBCAPTION", "YAXISNAME", "XAXISNAME", "DIVLINES", "YAXISVALUES", "DATALABELS", "DATAVALUES", "TRENDLINES", "TRENDVALUES", "DATAPLOT", "TOOLTIP", "VLINES", "VLINELABELS");
	...
	*/
	private function returnDataAsObject (label : String, value : Number, color : String, displayValue:String, alpha : Number, toolText : String, link : String, showLabel : Number, showValue : Number) : Object 
	{
		//Create a container
			...
			if (arrDocElement [i].nodeName.toUpperCase () == "GRAPH" || arrDocElement [i].nodeName.toUpperCase () == "CHART")
			{
				...
				for (j = 0; j < arrLevel1Nodes.length; j ++)
				{
					...
					if (arrLevel1Nodes [j].nodeName.toUpperCase () == "SET")
					{
						...
						this.data [this.num] = this.returnDataAsObject (setName, setValue, setColor, setExDispVal,  setAlpha, setToolText, setLink, setShowLabel, setShowValue);
	...
	*/
	private function calcVLinesPos ()
	{
		...
		for (i = 1; i <= numVLines; i ++)
		{
			...
			{
				//Set it's x position
				this.vLines [i].x = this.data [this.vLines [i].index].x + (this.data [this.vLines [i].index + 1].x - this.data [this.vLines [i].index].x)  * this.vLines[i].linePosition;
			} else 
			{
				//Invalidate it
