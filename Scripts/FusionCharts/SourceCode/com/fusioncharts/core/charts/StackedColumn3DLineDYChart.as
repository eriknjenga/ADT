...
class com.fusioncharts.core.charts.StackedColumn3DLineDYChart extends DualYAxis3DChart 
{
	...
	*/
	function StackedColumn3DLineDYChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		_arrObjects = new Array ("BACKGROUND", "CANVAS", "CAPTION", "SUBCAPTION", "YAXISNAME", "XAXISNAME", "DIVLINES", "YAXISVALUES", "DATALABELS", "DATAVALUES", "TRENDLINES", "TRENDVALUES", "DATAPLOTCOLUMN", "DATAPLOTLINE", "ANCHORS", "TOOLTIP", "VLINES", "LEGEND", "VLINELABELS");
	...
	*/
	private function parseAttributes (graphElement : XMLNode) : Void 
	{
		...
		//Whether to use 3D shift for line
		this.params.use3DLineShift = toBoolean (getFN (atts ["use3dlineshift"] , 0));
		...
		for (i = 1; i <= this.numDS; i ++)
		{
			if (this.dataset [i].parentYAxis == "S")
			{
				for (j = 1; j <= this.num; j ++)
				{
					...
					//Set the y position
					this.dataset [i].data [j].y = this.getAxisPosition (this.dataset [i].data [j].value, this.config.SYMax, this.config.SYMin, this.elements.canvasBg.y, this.elements.canvasBg.toY, true, 0) + (this.params.use3DLineShift?this.config.shifts.yShift:0);;
					//Store value textbox y position
	...
	*/
	private function drawHeaders ()
	{
		...
		if (this.params.caption != "")
		{
			...
			var captionObj : Object = createText (false, this.params.caption, this.cMC, this.dm.getDepth ("CAPTION") , this.elements.canvasBg.x + (this.elements.canvasBg.w / 2) , this.params.chartTopMargin, 0, captionStyleObj, true, this.elements.caption.w, this.elements.caption.h);
			//Apply animation
		...
		if (this.params.subCaption != "")
		{
			...
			var subCaptionObj : Object = createText (false, this.params.subCaption, this.cMC, this.dm.getDepth ("SUBCAPTION") , this.elements.canvasBg.x + (this.elements.canvasBg.w / 2) , this.elements.canvasBg.y - this.params.captionPadding, 0, subCaptionStyleObj, true, this.elements.subCaption.w, this.elements.subCaption.h);
			//Apply animation
			if (this.params.animation)
			{
