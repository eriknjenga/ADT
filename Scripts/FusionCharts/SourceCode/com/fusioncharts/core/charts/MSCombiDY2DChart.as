...
class com.fusioncharts.core.charts.MSCombiDY2DChart extends DualYAxis2DChart 
{
	...
	*/
	function MSCombiDY2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		_arrObjects = new Array ("BACKGROUND", "CANVAS", "CAPTION", "SUBCAPTION", "YAXISNAME", "XAXISNAME", "DIVLINES", "YAXISVALUES", "HGRID", "DATALABELS", "DATAVALUES", "TRENDLINES", "TRENDVALUES", "DATAPLOTCOLUMN", "DATAPLOTLINE", "DATAPLOTAREA", "ANCHORS", "TOOLTIP", "VLINES", "LEGEND", "VLINELABELS");
