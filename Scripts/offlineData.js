	...
	if(validated) {
		...
		selectEnvironmentVariables(function(transaction, results) {
			...
			if(form == "add_patient_form") {
				...
				var family_planning=retrieveSelectedFormValues_Array("family_planning");
				var other_illness_listings=retrieveSelectedFormValues_Array("other_illnesses_listing");
