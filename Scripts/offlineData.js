...
function loaded() {
	...
	if(document.getElementById("submit") == null) {
		...
		document.querySelector('#submit').addEventListener('click', processData, true);
	}
}
