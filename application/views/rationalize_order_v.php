...
<form method="post" action="<?php echo site_url('order_rationalization/save')?>">
...
foreach($regimens as $regimen){
		...
		<tbody>
			...
			?>
				<tr>
					<th>Comments:</th>
					<td colspan="3"><textarea rows="10" cols="30" name="comments"><?php echo $order_details -> Comments;?></textarea></td>
				</tr>
				<tr>
					<th>Action:</th>
					<td><input type="submit" class="button" value="Approve Order" name="approve_order" /><input type="submit" class="button" value="Decline Order" name="decline_order"/></td> 
				</tr> 
			</tbody>
	</table>
</form>
