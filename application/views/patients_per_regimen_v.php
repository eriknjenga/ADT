...
jQuery(document).ready(function() {
		   var chart = new FusionCharts("<?php echo site_url()?>scripts/FusionCharts/Pie2D.swf", "ChartId", "950", "600", "0", "0");
		   chart.setDataURL("<?php echo site_url()?>patient_statistics/patient_regimens/0/<?php echo date('Y');?>");
		   ...
		   jQuery("#filter_graph").click(function(){ 
				...
				var chart = new FusionCharts("<?php echo base_url()."Scripts/FusionCharts/Charts/Pie2D.swf"?>", "ChartId", "950", "600", "0", "0");	
				var url = '<?php echo base_url();?>patient_statistics/patient_regimens/'+selected_facility+'/'+selected_year; 
...
<div id="chart_area" class="chart_content" style="width:950px; height: 600px;"> 
