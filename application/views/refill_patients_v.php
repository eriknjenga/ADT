...
jQuery(document).ready(function() {
		   ...
		   chart.setDataURL("<?php echo site_url()?>patient_statistics/refill_stats/0/<?php echo date('Y');?>");
		   ...
		   jQuery("#filter_graph").click(function(){ 
				...
				var url = '<?php echo base_url();?>patient_statistics/refill_stats/'+selected_facility+'/'+selected_year; 
...
<div class="notification msginfo">
                        <a class="close"></a>
                        <p>Number of Patients who Visited for a Refill</p>
</div>
